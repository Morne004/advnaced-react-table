 ...
 */
export const useColumnDnd = ({ columnOrder, setColumnOrder, isResizing }: UseColumnDndProps) => {
  ...
  const handleDrop = (e: DragEvent<HTMLTableHeaderCellElement>, targetColumnId: string) => {
